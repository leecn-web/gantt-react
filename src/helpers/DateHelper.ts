...
export const ganttDateRange = (
  ...
  switch (viewMode) {
    case ViewMode.Month:
      ...
      newStartDate = addToDate(newStartDate, -1 * coefficientLeft, "year");
      newEndDate = addToDate(newEndDate, 1 * coefficientRight, "year");
      break;
    case ViewMode.Week:
    ...
    case ViewMode.Day:
      newStartDate = startOfDate(newStartDate, "day");
      newEndDate = startOfDate(newEndDate, "day");
      newStartDate = addToDate(newStartDate, -15 * coefficientLeft, "day");
      newEndDate = addToDate(newEndDate, 15 * coefficientRight, "day");
      break;
    ...
    case ViewMode.Hour:
      newStartDate = startOfDate(newStartDate, "day");
      newEndDate = startOfDate(newEndDate, "day");
      newStartDate = addToDate(newStartDate, -1 * coefficientLeft, "day");
      newEndDate = addToDate(newEndDate, 1 * coefficientRight, "day"); // 24
      break;
  }
  ...
  while (currentDate < endDate) {
    switch (viewMode) {
      ...
      case ViewMode.QuarterDay:
        ...
        break;
      case ViewMode.Hour:
        currentDate = addToDate(currentDate, 2, "hour");
        break;
    }
